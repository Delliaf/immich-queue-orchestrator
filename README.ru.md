...
<!-- translation-source: README.md; source-sha256: c46b06cc141d8abe090ea9e56a682dedfec315d1e561ae6aa46eb483c65ab476 -->

[English](README.md)

Внешний контроллер фоновых очередей Immich для домашних серверов с ограниченными CPU и RAM.

> Статус: ранний релиз `0.1.4`. Контракты проверены по Immich `v3.1.0`. До первого запуска на реальной библиотеке используйте `dryRun: true` и сделайте резервную копию.
