...
> Архивный документ: исходный handoff, зафиксированный до реализации `0.1.0`. Он не обновляется. Текущий план находится в [`../project-plan.md`](../project-plan.md), рядом доступен [перевод](../ru/project-plan.md).
